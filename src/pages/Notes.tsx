...
export default function Notes(): ReactElement {
  ...
  console.warn('aggregateNotes:', newNotes?.aggregateNotes)
  ...
  return (
    <div className="min-w-screen h-screen bg-background-1 flex flex-row">
      ...
      <Body notes={notes} selectedNote={selectedNote} setNotes={setNotes} actualNotes={actualNotes}
            setActualNotes={setActualNotes} />
    </div>
  )
}
